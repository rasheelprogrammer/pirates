...
class Wand(Weapon.Weapon):
    __module__ = __name__
    modelTypes = ['models/handheld/pir_m_hnd_stf_dark_a', 'models/handheld/pir_m_hnd_stf_dark_b', 'models/handheld/pir_m_hnd_stf_dark_c', 'models/handheld/pir_m_hnd_stf_dark_d', 'models/handheld/pir_m_hnd_stf_nature_a', 'models/handheld/pir_m_hnd_stf_nature_b', 'models/handheld/pir_m_hnd_stf_nature_c', 'models/handheld/pir_m_hnd_stf_nature_d', 'models/handheld/pir_m_hnd_stf_ward_a', 'models/handheld/pir_m_hnd_stf_ward_b', 'models/handheld/pir_m_hnd_stf_ward_c', 'models/handheld/pir_m_hnd_stf_ward_d']
    ...
    def startChargeEffect(self):
        ...
        if self.gem:
            if not self.gem.isEmpty():
                ...
                self.glowEffect and self.glowEffect.reparentTo(self.gem)
