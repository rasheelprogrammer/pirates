...
import random, os, copy, Pistol, Sword, Doll, Melee, Dagger, Grenade, Wand, Bayonet, MonsterMelee, Consumable, Weapon, DualCutlass, Foil, FishingRod, Gun, Torch, PowderKeg
...
def getRepId(inventoryId):
    if inventoryId <= ItemGlobals.CHARM_RANGE:
        typeId = inventoryId not in range(InventoryType.begin_FishingLures, InventoryType.end_FishingLures) and ItemGlobals.getType(inventoryId)
