...
import CannonGlobals, random, math
        ...
        for i in range(numShots):
            ...
            if hasattr(self, 'ship'):
                if self.ship:
                    ...
                    addFunc = (self.localAvatarUsingWeapon or wantCollisions) and (base.cr.cannonballCollisionDebug == 1 or base.cr.cannonballCollisionDebug == 3) and Func(base.cTrav.addCollider, collNode, ammo.collHandler)
