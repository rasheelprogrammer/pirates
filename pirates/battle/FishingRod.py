...
# Embedded file name: pirates.battle.FishingRod
...
class FishingRod(Weapon.Weapon):
    __module__ = __name__
    modelTypes = ['models/handheld/pir_m_hnd_tol_fishingPole', 'models/handheld/pir_m_hnd_tol_fishingPoleMed', 'models/handheld/pir_m_hnd_tol_fishingPoleLarge']
    models = {}
    icons = {}
    vertex_list = [
