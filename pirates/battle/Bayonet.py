...
class Bayonet(Weapon.Weapon):
    __module__ = __name__
    modelTypes = ['models/handheld/pir_m_hnd_gun_musket_a', 'models/handheld/pir_m_hnd_gun_musket_b', 'models/handheld/pir_m_hnd_gun_musket_c', 'models/handheld/pir_m_hnd_gun_musket_d', 'models/handheld/pir_m_hnd_gun_musket_e']
    ...
    def getAnimState(self, av, animState):
        if av.isNpc:
            return animState == 'LandRoam' and 'BayonetLandRoam'
        else:
            return animState
