...
# Embedded file name: pirates.minigame.CannonDefenseFSM
        ...
        if self._countDownUI:
            ...
            if timeLeft <= 2:
                if localAvatar.cannon:
                    if hasattr(localAvatar.cannon, 'ammoPanel'):
                        localAvatar.cannon.ammoPanel.state == pirates.minigame.AmmoPanel.OPENED and localAvatar.cannon.ammoPanel.onTabClick()
