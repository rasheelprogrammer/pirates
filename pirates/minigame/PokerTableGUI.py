            ...
            if newHand:
                if PlayingCardGlobals.Unknown not in newHand:
                    if self.table.handIdArray:
                        ...
                        sortedHand = handId > PlayingCardGlobals.Nothing and self.table.sortedCardsArray[seat]
    ...
    def setLocalAvatarHand(self, cardValues):
        ...
        if cardValues:
            if PlayingCardGlobals.Unknown not in cardValues:
                (self.handId == PlayingCardGlobals.Nothing or self.sortedCards == None) and handNameLabel.hide()
            else:
