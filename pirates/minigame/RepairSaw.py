...
# Embedded file name: pirates.minigame.RepairSaw
import math
        ...
        if base.mouseWatcherNode.hasMouse():
            ...
            if self.sawingGame.lastHitIndex >= 0:
                if self.sawingGame.sawWaypoints[0].hit:
                    ...
                    dir = -1
                if len(self.sawingGame.sawWaypoints) > self.sawingGame.lastHitIndex + dir >= 0:
                ...
                if moveDiff > 0.0:
                    ...
                    abs(anglediff) <= RepairGlobals.Sawing.sawTurnSpeed * dt and self.setR(goalR)
                else:
