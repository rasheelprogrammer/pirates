...
# Embedded file name: pirates.minigame.FishingGameFSM
import random
...
class FishingGameFSM(FSM.FSM):
    ...
    def enterReward(self):
        ...
        if self.gameObject.fishManager.activeFish.myData['size'] == 'small':
            ...
            if self.gameObject.fishManager.activeFish.myData['size'] == 'medium':
                if i == 0:
                ...
                if self.gameObject.fishManager.activeFish.myData['size'] == 'large':
                    if i == 0:
