...
# Embedded file name: pirates.minigame.DistributedBlackjackTable
from direct.directnotify import DirectNotifyGlobal
from direct.interval.IntervalGlobal import *
from direct.gui.DirectGui import *
from pandac.PandaModules import *
from direct.task import Task
import random, math, DistributedGameTable, PlayingCardGlobals, PlayingCard, BlackjackTableGUI
        ...
        if seatIndex >= 0:
            ...
            if actor:
                ...
                if action[0] == PlayingCardGlobals.Hit:
                    ...
                    sfx = self.isLocalAvatarSeated() and None
                    audio = self.getAudio()
                    if audio:
    ...
    def cheatResponse(self, cheatType, cheatTarget, success, hand):
        ...
        if self.gui:
            if swap:
                ...
                if self.isLocalAvatarSeated():
                    actor = self.isLocalAvatarPlaying() and self.actors[self.localAvatarSeat]
