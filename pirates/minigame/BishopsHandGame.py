    ...
    def strike(self, danger):
        ...
        def check(angle):
            if angle <= BishopsHandGlobals.FINGER_RANGES[0][0]:
                ...
                if BishopsHandGlobals.FINGER_RANGES[0][0] < angle <= BishopsHandGlobals.FINGER_RANGES[0][1]:
                    mistake = 1
                    id = 1
                else:
                    if BishopsHandGlobals.FINGER_RANGES[0][1] < angle <= BishopsHandGlobals.FINGER_RANGES[1][0]:
                        mistake = 0
                        id = 1
                    else:
                        if BishopsHandGlobals.FINGER_RANGES[1][0] < angle <= BishopsHandGlobals.FINGER_RANGES[1][1]:
                            mistake = 1
                            id = 2
                        else:
                            if BishopsHandGlobals.FINGER_RANGES[1][1] < angle <= BishopsHandGlobals.FINGER_RANGES[2][0]:
                                mistake = 0
                                id = 2
                            else:
                                if BishopsHandGlobals.FINGER_RANGES[2][0] < angle <= BishopsHandGlobals.FINGER_RANGES[2][1]:
                                    mistake = 1
                                    id = 3
                                else:
                                    if BishopsHandGlobals.FINGER_RANGES[2][1] < angle <= BishopsHandGlobals.FINGER_RANGES[3][0]:
                                        mistake = 0
                                        id = 3
                                    else:
                                        if BishopsHandGlobals.FINGER_RANGES[3][0] < angle <= BishopsHandGlobals.FINGER_RANGES[3][1]:
                                            mistake = 1
                                            id = 4
                                        else:
                                            mistake = 0
