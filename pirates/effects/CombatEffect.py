...
class CombatEffect(NodePath):
    ...
    def __init__(self, effectId, multihit=0, attacker=None, skillResult=0):
        ...
        if skillResult in [WeaponGlobals.RESULT_MISTIMED_MISS, WeaponGlobals.RESULT_MISTIMED_HIT]:
            self.mistimed = 1
    ...
    def loadEffects(self):
        ...
        if self.attacker:
            if self.attacker.currentWeapon:
                if hasattr(self.attacker.currentWeapon, 'colorAndOffset'):
                ...
                if self.effectId == WeaponGlobals.VFX_HACK:
                    ...
                    if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsHigh:
                        ...
                        if self.effectId == WeaponGlobals.VFX_SLASH:
                            effect = HitFlashA.getEffect(unlimited)
                            if effect:
                                effect.reparentTo(self)
                                effect.useRay = 1
                            ...
                            if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsHigh:
                                if not self.mistimed:
                                    effect = SparkBurst.getEffect(unlimited)
                                    effect and effect.reparentTo(self)
                                    effect.setPos(0, 0, 1.0)
                                    effect.particleDummy.reparentTo(self)
                                    effectAnims.append(Func(effect.play, 'Yellow'))
                                    self.effects.append(effect)
                        else:
                            if self.effectId == WeaponGlobals.VFX_CLEAVE:
                                effect = HitFlashA.getEffect(unlimited)
                                if effect:
                                    effect.reparentTo(self)
                                    effect.useRay = 1
                                ...
                                if self.effectId == WeaponGlobals.VFX_FLOURISH and self.hitNum == 0:
                                    effect = HitFlashA.getEffect(unlimited)
                                    if effect:
                                        effect.reparentTo(self)
                                        effect.useRay = 1
                                    ...
                                    if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsHigh:
                                        ...
                                        effect = self.hitNum == 1 and HitFlashA.getEffect(unlimited)
                                        if effect:
                                            effect.reparentTo(self)
                                            effect.useRay = 1
                                            effect.useSpark = 1
                                            ...
                                            if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsHigh:
                                                if not self.mistimed:
                                                    ...
                                                    if shockwaveHitEffect:
                                                        ...
                                                        self.effects.append(shockwaveHitEffect)
                                                    shockwaveHitEffect = ShockwaveHit.getEffect(unlimited)
                                                    shockwaveHitEffect and shockwaveHitEffect.reparentTo(self)
                                    ...
                                    if self.effectId == WeaponGlobals.VFX_STAB:
                                        effect = HitFlashA.getEffect(unlimited)
                                        if effect:
                                            effect.reparentTo(self)
                                            effect.useRay = 1
                                        ...
                                        if self.effectId == WeaponGlobals.VFX_TAUNT:
                                            pass
                                        else:
                                            if self.effectId == WeaponGlobals.VFX_BRAWL:
                                                effect = HitFlashA.getEffect(unlimited)
                                                if effect:
                                                    effect.reparentTo(self)
                                                    effect.useRay = 0
                                                ...
                                                if self.effectId == WeaponGlobals.VFX_SWEEP:
                                                    effect = HitFlashA.getEffect(unlimited)
                                                    if effect:
                                                        effect.reparentTo(self)
                                                        effect.useRay = 1
                                                    ...
                                                    if self.effectId == WeaponGlobals.VFX_BLADESTORM:
                                                        if self.hitNum == 0:
                                                            effect = HitFlashA.getEffect(unlimited)
                                                            if effect:
                                                                effect.reparentTo(self)
                    ...
                    if self.effectId == WeaponGlobals.VFX_BROADSWORD_HACK:
                        ...
                        if self.effectId == WeaponGlobals.VFX_BROADSWORD_SLASH:
                            effect = HitFlashA.getEffect(unlimited)
                            if effect:
                                effect.reparentTo(self)
                                effect.useRay = 1
                            ...
                            if self.effectId == WeaponGlobals.VFX_BROADSWORD_CLEAVE:
                                effect = HitFlashA.getEffect(unlimited)
                                if effect:
                                    effect.reparentTo(self)
                                    effect.useRay = 1
                                ...
                                if self.effectId == WeaponGlobals.VFX_BROADSWORD_FLOURISH:
                                    effect = HitFlashA.getEffect(unlimited)
                                    if effect:
                                        effect.reparentTo(self)
                                        effect.useRay = 1
                                    ...
                                    if self.effectId == WeaponGlobals.VFX_BROADSWORD_STAB:
                                        effect = HitFlashA.getEffect(unlimited)
                                        if effect:
                                            effect.reparentTo(self)
                                            effect.useRay = 1
                                        ...
                                        if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsHigh:
                                            if not self.mistimed:
                                                ...
                                                effectAnims.append(Func(effect.play, 'Yellow'))
                                                self.effects.append(effect)
                    effect = self.effectId == WeaponGlobals.VFX_SABER_HACK and HitFlashA.getEffect(unlimited)
                    if effect:
                        effect.reparentTo(self)
                        effect.useRay = 1
                        effect.useSpark = 0
                        ...
                        effectAnims.append(Func(effect.play))
                        self.effects.append(effect)
                    effect = base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsHigh and not self.mistimed and SparkBurst.getEffect(unlimited)
                    effect and effect.reparentTo(self)
                    effect.setPos(0, 0, 2.0)
                    effect.particleDummy.reparentTo(self)
                    effectAnims.append(Func(effect.play, 'Yellow'))
                    self.effects.append(effect)
        if self.effectId == WeaponGlobals.VFX_SABER_SLASH:
            effect = HitFlashA.getEffect(unlimited)
            if effect:
                effect.reparentTo(self)
                effect.useRay = 1
            ...
            if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsHigh:
                if not self.mistimed:
                    ...
                    effectAnims.append(Func(effect.play, 'Yellow'))
                    self.effects.append(effect)
        if self.effectId == WeaponGlobals.VFX_SABER_CLEAVE and self.hitNum == 0:
            effect = HitFlashA.getEffect(unlimited)
            if effect:
                effect.reparentTo(self)
                effect.useRay = 1
                ...
                if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsHigh:
                    ...
                    if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsHigh:
                        if not self.mistimed:
                            ...
                            effectAnims.append(Func(shockwaveHitEffect.play))
                            self.effects.append(shockwaveHitEffect)
        if self.effectId == WeaponGlobals.VFX_SABER_FLOURISH and self.hitNum == 0:
            effect = HitFlashA.getEffect(unlimited)
            if effect:
                effect.reparentTo(self)
                effect.useRay = 1
                ...
                if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsHigh:
                    ...
                    if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsHigh:
                        if not self.mistimed:
                            ...
                            effectAnims.append(Func(shockwaveHitEffect.play))
                            self.effects.append(shockwaveHitEffect)
        if self.effectId == WeaponGlobals.VFX_SABER_STAB:
            effect = HitFlashA.getEffect(unlimited)
            if effect:
                effect.reparentTo(self)
                effect.useRay = 1
            ...
            if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsHigh:
                if not self.mistimed:
                    ...
                    effectAnims.append(Func(effect.play, 'Yellow'))
                    self.effects.append(effect)
        if self.effectId == WeaponGlobals.VFX_CUT:
            effect = HitFlashA.getEffect(unlimited)
            if effect:
                effect.reparentTo(self)
                effect.useRay = 1
            ...
            if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsHigh:
                if not self.mistimed:
                    ...
                    effectAnims.append(Func(effect.play, 'Yellow'))
                    self.effects.append(effect)
        if self.effectId == WeaponGlobals.VFX_MULTIHIT:
            if self.hitNum == 0:
                effect = HitFlashA.getEffect(unlimited)
                if effect:
                    effect.reparentTo(self)
                ...
                if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsHigh:
                    ...
                    if effect:
                        ...
                        effectAnims.append(Func(effect.play, 'Yellow'))
                        self.effects.append(effect)
        if self.effectId == WeaponGlobals.VFX_SWIPE:
            effect = HitFlashA.getEffect(unlimited)
            if effect:
                effect.reparentTo(self)
                effect.useRay = 1
            ...
            if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsHigh:
                if not self.mistimed:
                    ...
                    effectAnims.append(Func(effect.play, 'Yellow'))
                    self.effects.append(effect)
        if self.effectId == WeaponGlobals.VFX_IMPALE and self.hitNum == 0:
            effect = HitFlashA.getEffect(unlimited)
            if effect:
                effect.reparentTo(self)
                effect.useRay = 1
                    ...
                    if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsHigh:
                        if not self.mistimed:
                            ...
                            if effect:
                                ...
                                effectAnims.append(Func(effect.play, 'Yellow'))
                                self.effects.append(effect)
                if self.effectId == WeaponGlobals.VFX_THUNDERBOLT:
                    ...
                    if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsHigh:
                        ...
                        effect2.fadeTime = 0.3
                        effectAnims.append(Func(effect2.play))
                        self.effects.append(effect2)
                if self.effectId == WeaponGlobals.VFX_THROWHIT:
                    effect = HitFlashA.getEffect(unlimited)
                    if effect:
                        effect.reparentTo(self)
                        effect.useRay = 1
                    ...
                    if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsHigh:
                        ...
                        if effect:
                            ...
                            effectAnims.append(Func(effect.play, 'Yellow'))
                            self.effects.append(effect)
                if self.effectId == WeaponGlobals.VFX_POISON:
                    effect = HitFlashA.getEffect(unlimited)
                    if effect:
                        effect.reparentTo(self)
                        effect.useRay = 0
                    ...
                    if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsMedium:
                        ...
                        if effect:
                            ...
                            effectAnims.append(Func(effect.play))
                            self.effects.append(effect)
                if self.effectId == WeaponGlobals.VFX_BLIND:
                    effect = HitFlashA.getEffect(unlimited)
                    if effect:
                        effect.reparentTo(self)
                        effect.useRay = 0
                        ...
                        effectAnims.append(Func(effect.play))
                        self.effects.append(effect)
                if self.effectId == WeaponGlobals.VFX_WOUND:
                    effect = HitFlashA.getEffect(unlimited)
                    if effect:
                        effect.reparentTo(self)
                        effect.useRay = 1
                    ...
                    if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsHigh:
                        ...
                        if shockwaveHitEffect:
                            ...
                            effectAnims.append(Func(shockwaveHitEffect.play))
                            self.effects.append(shockwaveHitEffect)
                if self.effectId == WeaponGlobals.VFX_TRIPLEHIT:
                    ...
                    if hitNum == 0:
                        ...
                        if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsHigh:
                            ...
                            if effect:
                                ...
                                effectAnims.append(Func(effect.play, 'Blue'))
                                self.effects.append(effect)
                if self.effectId == WeaponGlobals.VFX_WASP:
                    if self.hitNum == 0:
                        ...
                        pass
                if self.effectId == WeaponGlobals.VFX_CURSE:
                    if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsHigh:
                    ...
                    if effect:
                        ...
                        effectAnims.append(Func(effect.play))
                        self.effects.append(effect)
                if self.effectId == WeaponGlobals.VFX_HEAL:
                    effect = HitFlashA.getEffect(unlimited)
                    if effect:
                        effect.reparentTo(self)
                        effect.useRay = 0
                    ...
                    if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsHigh:
                        ...
                        if effect:
                            ...
                            effectAnims.append(Func(effect.play))
                            self.effects.append(effect)
                if self.effectId == WeaponGlobals.VFX_CURE:
                    effect = HitFlashA.getEffect(unlimited)
                    if effect:
                        effect.reparentTo(self)
                        effect.useRay = 0
                    ...
                    if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsHigh:
                        ...
                        if effect:
                            ...
                            effectAnims.append(Func(effect.play))
                            self.effects.append(effect)
                if self.effectId == WeaponGlobals.VFX_TONIC:
                    effect = HitFlashA.getEffect(unlimited)
                    if effect:
                        effect.reparentTo(self)
                        effect.useRay = 0
                    ...
                    if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsHigh:
                        ...
                        if effect:
                            ...
                            effectAnims.append(Func(effect.play))
                            self.effects.append(effect)
                if self.effectId == WeaponGlobals.VFX_FIRE:
                    ...
                    if effect:
                        ...
                        effectAnims.append(Func(effect.play))
                        self.effects.append(effect)
                if self.effectId == WeaponGlobals.VFX_ATTUNE:
                    effect = HitFlashA.getEffect(unlimited)
                    if effect:
                        effect.reparentTo(self)
                        effect.useRay = 0
                        ...
                        effectAnims.append(Func(effect.play))
                        self.effects.append(effect)
                if self.effectId == WeaponGlobals.VFX_POKE:
                    ...
                    effectAnims.append(Func(effect.play))
                    self.effects.append(effect)
        if self.effectId == WeaponGlobals.VFX_DRAINLIFE:
            ...
            if self.effectId == WeaponGlobals.VFX_CLEANSE:
                ...
                if self.effectId == WeaponGlobals.VFX_DOLL_SPIRIT_GUARD:
                    if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsMedium:
                        effect = HealSmoke.getEffect(unlimited)
                        if effect:
                            effect.reparentTo(self)
                    ...
                    if self.effectId == WeaponGlobals.VFX_DOLL_WIND_GUARD:
                        if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsMedium:
                            effect = HealSmoke.getEffect(unlimited)
                            if effect:
                                effect.reparentTo(self)
                        ...
                        if self.effectId == WeaponGlobals.VFX_DOLL_HEX_GUARD:
                            if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsMedium:
                                effect = HealSmoke.getEffect(unlimited)
                                if effect:
                                    effect.reparentTo(self)
                                    effect.setPos(self, 0, 0, -2.0)
                                    effect.setEffectColor(Vec4(0.5, 0.3, 1, 1), wantBlending=True)
                                    effectAnims.append(Func(effect.play))
                                    self.effects.append(effect)
                        else:
                            if self.effectId == WeaponGlobals.VFX_DOLL_RED_FURY:
                                if base.options.getSpecialEffectsSetting() >= base.options.SpecialEffectsMedium:
                                    effect = HealSmoke.getEffect(unlimited)
                                    if effect:
                                        effect.reparentTo(self)
                                ...
                                if self.effectId == WeaponGlobals.VFX_VOODOO or self.effectId == WeaponGlobals.VFX_SOULFLAY:
                                    ...
                                    if self.effectId == WeaponGlobals.VFX_PESTILENCE:
                                        ...
                                        if self.effectId == WeaponGlobals.VFX_BANISH:
                                            ...
                                            if self.effectId == WeaponGlobals.VFX_WITHER or self.effectId == WeaponGlobals.VFX_DESOLATION:
                                                ...
                                                if self.effectId == WeaponGlobals.VFX_HELLFIRE:
                                                    if base.options.getSpecialEffectsSetting() == base.options.SpecialEffectsLow:
                                                        effect = FireballHit.getEffect(unlimited)
                                                        if effect:
                                                            effect.reparentTo(self)
                                                    ...
                                                    if self.effectId == WeaponGlobals.VFX_JR_HIT:
                                                        ...
                                                        if self.effectId == WeaponGlobals.VFX_JR_BOLT:
                                                            ...
                                                            if self.effectId == WeaponGlobals.VFX_CURSED_BOLT:
                                                                ...
                                                                if self.effectId == WeaponGlobals.VFX_NO_EFFECT:
                                                                    pass
                                                                else:
                                                                    effect = HitFlashA.getEffect(unlimited)
                                                                    if effect:
