...
1063     217  LOAD_FAST             0  'self'
       ...
       242_0  COME_FROM           213  '213'
       242_1  COME_FROM           200  '200'
         242  POP_TOP          
       243_0  COME_FROM           239  '239'
...
1064     243  LOAD_FAST             0  'self'
         ...
         258  CALL_FUNCTION_256   256  None
         261  POP_TOP          
       262_0  COME_FROM           190  '190'

1065     262  LOAD_FAST             0  'self'
         265  LOAD_ATTR            26  'setEnableDisable'
         268  CALL_FUNCTION_0       0  None
         271  POP_TOP          
...
Parse error at or near `LOAD_FAST' instruction at offset 194
    ...
    def repackFog(self):
        if self.todMgr.fogType == TODGlobals.FOG_LINEAR:
            ...
            if self.todMgr.fogType == TODGlobals.FOG_EXP:
    ...
    def saveChanges(self):
        ...
        if self.holdFogColor != None:
            if self.holdFogExp != None:
                settingDict = self.holdLinearRanges != None and self.holdAmbientColor != None and self.holdDirectionColor != None and self.holdBackColor != None and self.holdSunDirection != None and {}
                ...
                self.editor and self.todMgr.insertTODSettingDict(TODGlobals.ENV_DATAFILE, self.todMgr.currentState, settingDict)
            else:
