...
# Embedded file name: pirates.cutscene.CutsceneIvals
...
def subtitleSequence(cutsceneId):
    if hasattr(base, 'pe'):
        if base.pe.panel.showCutsceneSubtitle.get() == 0:
        ...
        if not ('localAvatar' not in __builtins__ and __builtins__.has_key('subtitler')):
