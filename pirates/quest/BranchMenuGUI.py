...
# Embedded file name: pirates.quest.BranchMenuGUI
...
class BranchMenuGUI(DirectFrame):
    ...
    def setOffers(self, offer):
        ...
        for i, offer in zip(range(len(offers)), offers):
            ...
            if PLocalizer.QuestStrings.has_key(offerName):
                questTitle = 'title' in PLocalizer.QuestStrings[offerName].keys() and PLocalizer.QuestStrings[offerName]['title']
            else:
