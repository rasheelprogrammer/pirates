...
def getPropType(propId):
    if propId in PropIds.PropDefs.get(PropIds.ANY_BARREL):
        ...
        if propId in PropIds.PropDefs.get(PropIds.ANY_CRATE):
            return PropIds.ANY_CRATE
        else:
            if propId in PropIds.PropDefs.get(PropIds.ANY_DESK):
                return PropIds.ANY_DESK
            else:
                if propId in PropIds.PropDefs.get(PropIds.ANY_SHELF):
                    return PropIds.ANY_SHELF
                else:
                    if propId in PropIds.PropDefs.get(PropIds.ANY_CLOCK):
                        return PropIds.ANY_CLOCK
                    else:
                        if propId in PropIds.PropDefs.get(PropIds.ANY_CABINET):
                            return PropIds.ANY_CABINET
                        else:
                            if propId in PropIds.PropDefs.get(PropIds.ANY_HAYSTACK):
                                return PropIds.ANY_HAYSTACK
                            else:
                                if propId in PropIds.PropDefs.get(PropIds.ANY_WELL):
                                    return PropIds.ANY_WELL
                                else:
                                    if propId in PropIds.PropDefs.get(PropIds.ANY_GRAVE):
                                        return PropIds.ANY_GRAVE
                                    else:
                                        if propId in PropIds.PropDefs.get(PropIds.WATER_GRAVE):
                                            return PropIds.WATER_GRAVE
                                        else:
                                            if propId in PropIds.PropDefs.get(PropIds.SOUTH_GRAVE):
                                                return PropIds.SOUTH_GRAVE
                                            else:
                                                if propId in PropIds.PropDefs.get(PropIds.ANY_CHEST):
                                                    return PropIds.ANY_CHEST
                                                else:
                                                    if propId in PropIds.PropDefs.get(PropIds.ANY_MINE_SHAFT):
...
class TreasureIds:
    ...
    TreasureDefs = {PR_CHEST_1: (PR_CHEST_1,), PR_CHEST_2: (PR_CHEST_2,), PR_CHEST_3: (PR_CHEST_3,), PR_CHEST_4: (PR_CHEST_4,), PR_CHEST_5: (PR_CHEST_5,), PR_CHEST_6: (PR_CHEST_6,), PR_CHEST_7: (PR_CHEST_7,), PR_CHESTS: (PR_CHEST_1, PR_CHEST_2, PR_CHEST_3, PR_CHEST_4, PR_CHEST_5, PR_CHEST_6, PR_CHEST_7), PR_ROYAL_CAVERNS_CHEST_1: (PR_ROYAL_CAVERNS_CHEST_1,), PR_ROYAL_CAVERNS_CHEST_2: (PR_ROYAL_CAVERNS_CHEST_2,), PR_ROYAL_CAVERNS_CHEST_3: (PR_ROYAL_CAVERNS_CHEST_3,), PR_ROYAL_CAVERNS_CHEST_4: (PR_ROYAL_CAVERNS_CHEST_4,), PR_ROYAL_CAVERNS_CHEST_5: (PR_ROYAL_CAVERNS_CHEST_5,), PR_ROYAL_CAVERNS_CHEST_6: (PR_ROYAL_CAVERNS_CHEST_6,), PR_ROYAL_CAVERNS_CHESTS: (PR_ROYAL_CAVERNS_CHEST_1, PR_ROYAL_CAVERNS_CHEST_2, PR_ROYAL_CAVERNS_CHEST_3, PR_ROYAL_CAVERNS_CHEST_4, PR_ROYAL_CAVERNS_CHEST_5, PR_ROYAL_CAVERNS_CHEST_6), PR_WICKED_CHESTS: (PR_WICKED_CHEST_1, PR_WICKED_CHEST_2, PR_WICKED_CHEST_3, PR_WICKED_CHEST_4, PR_WICKED_CHEST_5, PR_WICKED_CHEST_6, PR_WICKED_CHEST_7, PR_WICKED_CHEST_8), PR_MURKY_CHESTS: (PR_MURKY_CHEST_1, PR_MURKY_CHEST_2, PR_MURKY_CHEST_3, PR_MURKY_CHEST_4, PR_MURKY_CHEST_5, PR_MURKY_CHEST_6), PR_GOVERNOR_G_CHEST_1: (PR_GOVERNOR_G_CHEST_1,), PR_GOVERNOR_G_CHEST_2: (PR_GOVERNOR_G_CHEST_2,), PR_GOVERNOR_G_CHEST_3: (PR_GOVERNOR_G_CHEST_3,), PR_GOVERNOR_G_CHEST_4: (PR_GOVERNOR_G_CHEST_4,), PR_GOVERNOR_G_CHEST_5: (PR_GOVERNOR_G_CHEST_5,), PR_GOVERNOR_G_CHEST_6: (PR_GOVERNOR_G_CHEST_6,), PR_GOVERNOR_G_CHEST_7: (PR_GOVERNOR_G_CHEST_7,), PR_GOVERNOR_G_CHESTS: (PR_GOVERNOR_G_CHEST_1, PR_GOVERNOR_G_CHEST_2, PR_GOVERNOR_G_CHEST_3, PR_GOVERNOR_G_CHEST_4, PR_GOVERNOR_G_CHEST_5, PR_GOVERNOR_G_CHEST_6, PR_GOVERNOR_G_CHEST_7), CUTTS_TREASURE: (CUTTS_TREASURE,), SCORPION_TREASURE: (SCORPION_TREASURE,), FLYTRAP_TREASURE: (FLYTRAP_TREASURE,), T_CHEST_5: (T_CHEST_5,), T_CHEST_6: (T_CHEST_6,), T_CHEST_7: (T_CHEST_7,), T_CHEST_8: (T_CHEST_8,), T_CHEST_9: (T_CHEST_9,), T_CHEST_10: (T_CHEST_10,), T_CHESTS: (T_CHEST_4, T_CHEST_5, T_CHEST_6, T_CHEST_7, T_CHEST_8, T_CHEST_9, T_CHEST_10), T_W_CHESTS: (T_W_CHEST_1, T_W_CHEST_2, T_W_CHEST_3, T_W_CHEST_4), T_RN_CHESTS: (T_RN_CHEST_1, T_RN_CHEST_2, T_RN_CHEST_3, T_RN_CHEST_4, T_RN_CHEST_5, T_RN_CHEST_6, T_RN_CHEST_7, T_RN_CHEST_8, T_RN_CHEST_9), T_MM_CHESTS: (T_MM_CHEST_1, T_MM_CHEST_2), DF_CHEST_1: (DF_CHEST_1,), DF_CHEST_2: (DF_CHEST_2,), DF_CHEST_3: (DF_CHEST_3,), DF_CHEST_4: (DF_CHEST_4,), DF_CHEST_5: (DF_CHEST_5,), DF_CHESTS: (DF_CHEST_1, DF_CHEST_2, DF_CHEST_3, DF_CHEST_4, DF_CHEST_5), DF_CHEST_CAVE_D_1: (DF_CHEST_CAVE_D_1,), DF_CHEST_CAVE_D_2: (DF_CHEST_CAVE_D_2,), DF_CHEST_CAVE_D_3: (DF_CHEST_CAVE_D_3,), DF_CHEST_CAVE_D_4: (DF_CHEST_CAVE_D_4,), DF_CHEST_CAVE_D_5: (DF_CHEST_CAVE_D_5,), DF_CHEST_CAVE_D_6: (DF_CHEST_CAVE_D_6,), DF_CHEST_CAVE_D_7: (DF_CHEST_CAVE_D_7,), DF_CHEST_CAVE_D: (DF_CHEST_CAVE_D_1, DF_CHEST_CAVE_D_2, DF_CHEST_CAVE_D_3, DF_CHEST_CAVE_D_4, DF_CHEST_CAVE_D_5, DF_CHEST_CAVE_D_6, DF_CHEST_CAVE_D_7), TO_CAVERNS_CHESTS: (TO_CAVERNS_CHEST_1, TO_CAVERNS_CHEST_2, TO_CAVERNS_CHEST_3, TO_CAVERNS_CHEST_4, TO_CAVERNS_CHEST_5), KH_CHESTS: (KH_CHEST_1, KH_CHEST_2, KH_CHEST_3), KH_CHEST_1: (KH_CHEST_1,), KH_CHEST_2: (KH_CHEST_2,), KH_CHEST_3: (KH_CHEST_3,), RR_CHEST_1: (RR_CHEST_1,), RR_CHESTS: (RR_CHEST_1, RR_CHEST_2, RR_CHEST_3, RR_CHEST_4), CT_CHEST_1: (CT_CHEST_1,), DW_CHESTS: (DW_CHEST_1, DW_CHEST_2, DW_CHEST_3, DW_CHEST_4, DW_CHEST_5, DW_CHEST_6, DW_CHEST_7, DW_CHEST_8, DW_CHEST_9, DW_CHEST_10), IC_CHEST_1: (IC_CHEST_1,), IC_CHEST_9: (IC_CHEST_9,), IC_CHEST_11: (IC_CHEST_11,), IC_CHESTS: (IC_CHEST_1, IC_CHEST_2, IC_CHEST_3, IC_CHEST_4, IC_CHEST_5, IC_CHEST_6, IC_CHEST_7, IC_CHEST_8, IC_CHEST_9, IC_CHEST_10), IP_CHEST_1: (IP_CHEST_1,), IP_WASP_TREASURE: (IP_WASP_TREASURE,), OI_DJ_TREASURE: (OI_DJ_TREASURE,), OI_CHEST_1: (OI_CHEST_1,), OI_CHEST_2: (OI_CHEST_1,), OI_CHEST_3: (OI_CHEST_1,), OI_CHESTS: (OI_CHEST_1, OI_CHEST_2, OI_CHEST_3), RC_CHESTS: (RC_CHEST_1, RC_CHEST_2, RC_CHEST_3, RC_CHEST_4), RC_CHESTS_2: (RC_CHEST_5, RC_CHEST_6, RC_CHEST_7, RC_CHEST_8), ANY_TREASURE: None}
