...
# Embedded file name: pirates.quest.QuestRewardGUI
...
class QuestRewardGUI(QuestDetailBase):
    ...
    def showPanelAnimations(self):
        ...
        if self.reputation:
            if not self.gameGui.repMeter.mastered:
