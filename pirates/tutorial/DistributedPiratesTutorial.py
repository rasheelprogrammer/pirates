...
class DistributedPiratesTutorial(DistributedObject.DistributedObject, FSM.FSM):
            ...
            if done == 'created':
                ...
                if clothing:
                    ...
                    for clothId in clothing:
                        ...
                        if clothType:
                            clothing[clothId][0] and clothes.append([clothType, clothing[clothId][0], clothing[clothId][2]])
    ...
    def enterAct4DoneTutorial(self):
        ...
        if base.downloadWatcher:
            if hasattr(base.downloadWatcher, 'setStatusBarLocation'):
                base.downloadWatcher.setStatusBarLocation(2)
            base.launcher.getPhaseComplete(4) and self.leaveTutorial()
        else:
