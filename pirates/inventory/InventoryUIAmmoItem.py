...
# Embedded file name: pirates.inventory.InventoryUIAmmoItem
...
class InventoryUIAmmoItem(InventoryUIStackItem.InventoryUIStackItem):
    ...
    def showDetails(self, cell, detailsPos, detailsHeight, event=None):
        ...
        self.iconLabel = DirectLabel(parent=self.portraitSceneGraph, relief=None, image=SkillIcons.find('**/%s' % WeaponGlobals.getSkillIcon(self.getSkillId())), pos=(0.0,
                                                                                                                                                                       2.5,
                                                                                                                                                                       0.0))
        iHeight = 0.18
        self.createBuffer()
