...
# Embedded file name: pirates.inventory.InventoryUITattooDressingContainer
        ...
        for cell in self.cellList:
            ...
            if cell.slotId != None:
                if cell.slotId in Locations.RANGE_EQUIP_L_ARM_TATTOO:
                    ...
                    if cell.slotId in Locations.RANGE_EQUIP_R_ARM_TATTOO:
                        tattooIcon = tattooGui.find('**/icon_shop_tailor_arm')
                        scale = self.imageScale * self.cellSizeX * 0.6
                    else:
                        if cell.slotId in Locations.RANGE_EQUIP_CHEST_TATTOO:
                            tattooIcon = tattooGui.find('**/icon_shop_tailor_chest_male')
                            scale = self.imageScale * self.cellSizeX * 0.6
                        else:
                            if cell.slotId in Locations.RANGE_EQUIP_FACE_TATTOO:
