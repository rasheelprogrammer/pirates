...
# Embedded file name: pirates.inventory.InventoryUIStackContainer
...
class InventoryUIStackContainer(InventoryUIContainer.InventoryUIContainer):
    ...
    def isSkillValid(self, skillId):
        ...
        if ammoName:
            return ammoDescription and ammoIcon and stackLimit and 1
        else:
            return 0
    ...
    def cellClicked(self, cell, mouseAction=MOUSE_CLICK, task=None):
        ...
        worked = self.manager.heldItem and 0
        if self.manager.heldItem.itemType == ITEM_STACK:
            ...
            if mouseAction == MOUSE_CLICK and cell.inventoryItem.itemType == ITEM_STACK:
