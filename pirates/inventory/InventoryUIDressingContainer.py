...
# Embedded file name: pirates.inventory.InventoryUIDressingContainer
...
class InventoryUIDressingContainer(InventoryUISlotContainer.InventoryUISlotContainer):
    ...
    def canReceive(self, myCell, fromSwap=0, itemInQuestion=None):
        if itemInQuestion:
            pass
        if itemInQuestion:
            return not self.manager.canLocalUseItem(itemInQuestion.itemTuple)[0] and 0
        else:
