...
# Embedded file name: pirates.inventory.InventoryUIBeltGrid
        ...
        if cell:
            if cell.slotId:
                ...
                if cell.slotId in range(Locations.RANGE_EQUIP_WEAPONS[0], Locations.RANGE_EQUIP_WEAPONS[1] + 1):
                    ...
                    localAvatar.isWeaponDrawn and not localAvatar.checkForWeaponInSlot(localAvatar.currentWeaponId, localAvatar.currentWeaponSlotId) and localAvatar.getGameState() == 'Battle' and localAvatar.b_setGameState('LandRoam')
