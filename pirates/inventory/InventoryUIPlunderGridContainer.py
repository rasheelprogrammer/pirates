...
# Embedded file name: pirates.inventory.InventoryUIPlunderGridContainer
...
class InventoryUIPlunderGridContainer(InventoryUIContainer.InventoryUIContainer):
                                ...
                                if itemClass == InventoryType.TreasureCollection:
                                    ...
                                    if itemClass == InventoryCategory.CARDS:
                                        ...
                                        if itemClass == InventoryCategory.WEAPON_PISTOL_AMMO:
                                            ...
                                            if itemClass == InventoryCategory.MONEY:
    ...
    def postPickupLockout(self):
        if self.manager.heldItem:
            self.manager.heldItem.cell and self.manager.heldItem.cell in self.cellList and self.manager.heldItem.cell.hide()
        else:
            import pdb
            pdb.set_trace()
    ...
    def cellUsed(self, cell):
        ...
        if self.manager.heldItem:
            ...
            if cell.inventoryItem:
                self.manager.itemPickup = (cell.inventoryItem.itemType in (ITEM_STACK, ITEM_NOTRADE) or not self.manager.localInventoryOpen) and PICKUP_EMPTY
