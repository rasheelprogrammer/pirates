...
# Embedded file name: pirates.inventory.InventorySellConfirm
...
class InventorySellConfirm(BorderFrame):
    ...
    def setStackAmount(self, cell, amount):
        for sellCell in self.inventoryPanelSell.gridDict.values():
            if sellCell.inventoryItem:
                sellCell.inventoryItem.amount = sellCell.inventoryItem.inventoryCell == cell and amount
    ...
    def cancelItem(self):
        ...
        for sellCell in self.inventoryPanelSell.gridDict.values():
            if sellCell.inventoryItem:
                sellCell.inventoryItem.inventoryCell['state'] = (sellCell.inventoryItem.inventoryCell == cell and DGG).NORMAL
