    ...
    def handleAvatarControls(self, task):
            ...
            if self.straightHeading < minStraightSail and forward:
                ...
                if self.ship.threatCounter:
                    ...
                    if turnLeft or turnRight or not forward:
                        if forward:
                            self.straightHeading = self.straightHeading - dt * self.TURNING_BONUS_REDUCTION < minStraightSail and self.straightHeading >= minStraightSail and minStraightSail
                        else:
        ...
        if self.currentTurning < 0.001:
            ...
            if not physVel.almostEqual(Vec3(0), 0.1) or self.__speed or self.__slideSpeed or self.__rotationSpeed:
                ...
                newVector = Vec3(step)
                maxLen = (goForward and self).__speed
            else:
