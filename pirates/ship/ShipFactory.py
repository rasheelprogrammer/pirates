...
# Embedded file name: pirates.ship.ShipFactory
        ...
        for data in [(0, 'location_mainmast_0'), (1, 'location_mainmast_1'), (2, 'location_mainmast_2'), (3, 'location_aftmast*'), (4, 'location_foremast*')]:
            ...
            if mastData:
                ...
                if sailPatternTex:
                    ...
                    charBundle = mast.charRoot.getBundle(0)
                    mastHax and data[0] == 3 and breakAnims[0][0].storeAnim(charBundle.loadBindAnim(loader.loader, mast.breakAnim[0], -1, MastSubset, True), '1')
