    ...
    def announceGenerate(self):
        ...
        if self.avatarType.isA(AvatarTypes.Cannoneer):
            ...
            if self.avatarType.isA(AvatarTypes.Blacksmith):
                ...
                if self.avatarType.isA(AvatarTypes.Bartender):
                    self.shopInventory = MELEE_SHELF_L1 + MISSILE_SHELF_L1 + BOMB_SHELF_L1
                else:
                    if self.avatarType.isA(AvatarTypes.Gunsmith):
                        if base.config.GetBool('low-weapons-only', 0):
                        ...
                        if self.avatarType.isA(AvatarTypes.Grenadier):
                            ...
                            if self.avatarType.isA(AvatarTypes.Gypsy):
                                if base.config.GetBool('low-weapons-only', 0):
                                ...
                                if self.avatarType.isA(AvatarTypes.Merchant):
                                    self.shopInventory = PISTOL_AMMO_SHELF_L1 + MELEE_SHELF_L1 + MISSILE_SHELF_L1
                                else:
                                    if self.avatarType.isA(AvatarTypes.MedicineMan):
                ...
                if self.avatarType.isA(AvatarTypes.Barber):
                    ...
                    if self.avatarType.isA(AvatarTypes.Blacksmith):
                        ...
                        if self.avatarType.isA(AvatarTypes.Gunsmith):
                            ...
                            if self.avatarType.isA(AvatarTypes.Jeweler):
                                ...
                                if self.avatarType.isA(AvatarTypes.Shipwright):
                                    ...
                                    if self.avatarType.isA(AvatarTypes.Tailor):
                                        tex = DistributedShopKeeper.tailorCoin.copyTo(self.nametag3d)
                                    else:
                                        if self.avatarType.isA(AvatarTypes.Tattoo):
                                            ...
                                            if self.avatarType.isA(AvatarTypes.Gypsy):
                                                ...
                                                if self.avatarType.isA(AvatarTypes.Musician):
                                                    ...
                                                    if self.avatarType.isA(AvatarTypes.Trainer):
                                                        tex = DistributedShopKeeper.trainerCoin.copyTo(self.nametag3d)
                                                    else:
                                                        if self.avatarType.isA(AvatarTypes.PvPRewards):
                                                            ...
                                                            if self.avatarType.isA(AvatarTypes.Stowaway):
                                                                ...
                                                                if self.avatarType.isA(AvatarTypes.Cannonmaster):
                                                                    ...
                                                                    if self.avatarType.isA(AvatarTypes.Fishmaster):
                                                                        ...
                                                                        if self.avatarType.isA(AvatarTypes.CatalogRep):
    ...
    def startShopping(self, storeType):
        ...
        if storeType == InteractGlobals.STORE:
            ...
            if hasattr(self.cr.distributedDistrict, 'siegeManager'):
                ...
                self.storeMenuGUI = useSimpleStore and SimpleStoreGUI.MerchantStoreGUI(inventory, PLocalizer.MerchantStore, self)
            else:
                self.storeMenuGUI = StoreGUI.StoreGUI(inventory, PLocalizer.MerchantStore)
        else:
            if storeType == InteractGlobals.MUSICIAN:
                ...
                if storeType == InteractGlobals.STOWAWAY:
                    inventory = self.shopInventory[:]
                    self.storeMenuGUI = StowawayGUI.StowawayGUI(inventory, PLocalizer.StowawayMenuTitle)
                else:
                    if storeType == InteractGlobals.SHIPS:
                        self.storeMenuGUI = ShipStoreGUI.ShipStoreGUI(SHIP_SHELF, PLocalizer.Shipyard)
                    else:
                        if storeType == InteractGlobals.TRAIN:
                            pass
                        else:
                            if storeType == InteractGlobals.UPGRADE:
                                pass
                            else:
                                if storeType == InteractGlobals.ACCESSORIES_STORE:
                                    self.fadeIval = Sequence(Func(self.setTransparency, 1.0), self.colorScaleInterval(1.0, VBase4(1.0, 1.0, 1.0, 0.0)), Func(self.hide))
                                    self.fadeIval.start()
                                    if useSimpleStore:
                                    ...
                                    if storeType == InteractGlobals.TATTOO_STORE:
                                        self.fadeIval = Sequence(Func(self.setTransparency, 1.0), self.colorScaleInterval(1.0, VBase4(1.0, 1.0, 1.0, 0.0)), Func(self.hide))
                                        self.fadeIval.start()
                                        if useSimpleStore:
                                        ...
                                        if storeType == InteractGlobals.JEWELRY_STORE:
                                            self.fadeIval = Sequence(Func(self.setTransparency, 1.0), self.colorScaleInterval(1.0, VBase4(1.0, 1.0, 1.0, 0.0)), Func(self.hide))
                                            self.fadeIval.start()
                                            if useSimpleStore:
