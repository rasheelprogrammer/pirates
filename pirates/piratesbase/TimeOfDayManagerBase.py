...
# Embedded file name: pirates.piratesbase.TimeOfDayManagerBase
...
class TimeOfDayManagerBase:
    ...
    def addTimeOfDayToggle(self, uniqueName, startTime, endTime, startMethod=None, startArgs=[], endMethod=None, endArgs=[]):
        ...
        if currentInGameTime >= startTime:
            if currentInGameTime < endTime:
                if returnFlip:
                    returnVal = 0
                else:
                    returnVal = 1
            ...
            if self.togglesOn and not skipAdds:
                ...
                toggleOn = 0
                toggleOn = currentInGameTime >= startTime and currentInGameTime < endTime and 1
