...
# Embedded file name: pirates.piratesgui.InventoryItemGui
...
class InventoryItemGui(InventoryListItem):
    ...
    def getGeomParams(itemId):
        ...
        if itemType <= ItemType.WAND or itemType == ItemType.POTION:
            ...
            if itemType == ItemType.FISHING_ROD or itemType == ItemType.FISHING_LURE:
                ...
                if itemClass == ItemType.WEAPON or itemClass == ItemType.POUCH or itemClass == ItemType.AMMO:
                    asset = EconomyGlobals.getItemIcons(itemId)
                    if asset:
    ...
    def checkPlayerInventory(self, itemId, extraQty=0):
        itemCategory = self.available and EconomyGlobals.getItemCategory(itemId)
        ...
        if itemCategory == ItemType.AMMO or itemCategory == ItemType.CONSUMABLE:
            if currStock + extraQty >= currStockLimit:
                if currStockLimit > 0:
                ...
                if currStock >= 1:
                    ...
                    if itemRep == InventoryType.CutlassRep:
                        ...
                        if itemRep == InventoryType.PistolRep:
                            ...
                            if itemRep == InventoryType.DaggerRep:
                                options = [
                                ...
                                if itemRep == InventoryType.GrenadeRep:
                                    options = [
                                    ...
                                    if itemRep == InventoryType.DollRep:
                                        options = [
                                        ...
                                        if itemRep == InventoryType.WandRep:
                                            options = [
                ...
                if currStock >= 1:
                    ...
                    if itemId in pistolPouches:
                        ...
                        if itemId in daggerPouches:
                            ...
                            if itemId in grenadePouches:
                                pouchSet = grenadePouches
                            else:
                                if itemId in cannonPouches:
                ...
                if self.realItem:
                    ...
                    if posHpr:
                        ...
                        if itemType == ItemGlobals.SWORD:
                            ...
                            if itemSubtype in (ItemGlobals.MUSKET, ItemGlobals.BAYONET):
                                            ...
                                            if itemType == ItemGlobals.DAGGER:
                                                ...
                                                if itemType == ItemGlobals.GRENADE:
                                                    ...
                                                    if itemType == ItemGlobals.STAFF:
                                                        ...
                                                        if itemSubtype == ItemGlobals.RAM:
