...
# Embedded file name: pirates.piratesgui.ChestPanel
...
class ChestTab(LeftTab):
    ...
    def __init__(self, tabBar, name, **kw):
        optiondefs = (('modelName', 'general_frame_d', None), ('borderScale', 0.38, None), ('bgBuffer', 0.15, None), ('frameSize', (-0.125, 0.125, -0.1, 0.1), None), ('unfocusSize', (0, 0, 0, 0), None), ('focusSize', (-0.125, 0.125, -0.11, 0.11), None), ('heightFactor', 0.6, None), ('mouseEntered', None, None), ('mouseLeft', None, None))
