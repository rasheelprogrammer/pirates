                    ...
                    if self.item.get('Type') == 'Button':
                        ...
                        if self.item.get('Type') == 'Cargo':
                            ...
                            if self.item.get('Type') == 'Gold':
                                ...
                                if self.item.get('Type') == 'LootGold':
                                    ...
                                    if self.item.get('Type') == 'MaterialText':
                                        amount = self.item.get('Amount')
                                        ...
                                        if self.item.get('Type') == 'FreeMaterialRate':
                                            amount = self.item.get('Amount')
                                            ...
                                            if self.item.get('Type') == 'PaidMaterialRate':
                                                amount = self.item.get('Amount')
                                                ...
                                                if self.item.get('Type') == 'ShipMaterial':
                                                    amount = self.item.get('Amount')
                                                    ...
                                                    self.descText['geom_pos'] = (0.05,
                                                                                 0,
                                                                                 0.01)
                                                    self.descText['text_pos'] = (0.24,
                                                                                 0,
                                                                                 0)
                                                    self.descText['text'] = itemName
                                                    self.descText['text_fg'] = PiratesGuiGlobals.TextFG2
