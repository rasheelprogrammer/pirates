...
# Embedded file name: pirates.piratesgui.MainMenu
...
class MainMenu(DirectFrame):
    ...
    def __init__(self, title, x, y, width, height):
        ...
        if hotkeyConfig:
            ...
            self.magicButtons = magicWordConfig and []
    ...
    def logout_dialog_command(self, value):
        ...
        if value == 1:
            try:
                if base.cr.tutorialObject:
                    base.cr.tutorialObject.map and base.cr.tutorialObject.map.handleCancel()
                else:
