                                ...
                                if itemType == ItemId.CARGO_CRATE:
                                    ...
                                    if itemType == ItemId.CARGO_CHEST:
                                        ...
                                        if itemType == ItemId.CARGO_SKCHEST:
                                            ...
                                            if itemType == ItemId.CARGO_LOOTSAC:
                                                if quantity == 1:
                                                ...
                                                if itemType == ItemId.CARGO_LOOTCHEST:
                                                    if quantity == 1:
                                                    ...
                                                    if itemType == ItemId.CARGO_LOOTSKCHEST:
                                                        if quantity == 1:
                                                        ...
                                                        if itemType == ItemId.CARGO_SHIPUPGRADECHEST:
                                                            if quantity == 1:
                                                            ...
                                                            if itemType == ItemId.CARGO_SHIPUPGRADESKCHEST:
                                                                if quantity == 1:
