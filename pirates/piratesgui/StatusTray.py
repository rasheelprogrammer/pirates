...
# Embedded file name: pirates.piratesgui.StatusTray
    ...
    def updateHp(self, hp, maxHp, srcDoId=None):
        ...
        if srcDoId != self.doId:
            ...
            if self.doId != self.prevDoId:
                ...
                self.prevValue > hp and self.hpMeterChange.setColor(1.0, 0.0, 0.0, 1.0)
                ...
                if currentTime is None:
                    ...
                    return
                currentTime >= 0.5 and self.hpMeterDownIval.start()
            else:
    ...
    def updateStatusEffects(self, effects):
        ...
        for effectKeyId in effectIdList:
            ...
            if effectKeyId not in self.skillEffects.keys():
                effectId not in [WeaponGlobals.C_VOODOO_STUN, WeaponGlobals.C_VOODOO_HEX_STUN, WeaponGlobals.C_INTERRUPTED, WeaponGlobals.C_OPENFIRE, WeaponGlobals.C_TAKECOVER, WeaponGlobals.C_ATTUNE, WeaponGlobals.C_SPIRIT, WeaponGlobals.C_BANE, WeaponGlobals.C_MOJO, WeaponGlobals.C_WRECKHULL, WeaponGlobals.C_WRECKMASTS, WeaponGlobals.C_SINKHER, WeaponGlobals.C_INCOMING, WeaponGlobals.C_SUMMON_GHOST] and self.statusEffectsPanel.addStatusEffect(effectId, duration, timeLeft, ts, attackerId)
            else:
