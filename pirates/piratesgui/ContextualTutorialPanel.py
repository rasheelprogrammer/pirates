...
# Embedded file name: pirates.piratesgui.ContextualTutorialPanel
            ...
            if contextId == InventoryType.BrokenHull:
                ...
                if contextId == InventoryType.SearchableContainers:
                    ...
                    if contextId == InventoryType.NewSkillPoint:
                        ...
                        if contextId == InventoryType.DockCommands:
                            number == 4 and self.accept('space', self.closePanel)
                        else:
                            if contextId == InventoryType.ChatPreferences:
                                ...
                                if contextId == InventoryType.FishingTutorial:
                                    pass
            if not title:
                return False
