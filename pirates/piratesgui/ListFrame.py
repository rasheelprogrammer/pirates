...
# Embedded file name: pirates.piratesgui.ListFrame
        ...
        for currItem in itemList:
            if currItem is not None:
                if isinstance(currItem, tuple) or isinstance(currItem, list):
                    ...
                    if itemType == None or itemType != 'Space':
                        self.delayedReveal and revealTime += self.revealSpeed
...
#                 attribute (2)
#                      0. expr
#                                    576  LOAD_DEREF            0  'self'
#                      1.            579  LOAD_ATTR            43  'delayedReveal'
#              1. jmp_false (2)
#                  0.            582  JUMP_IF_FALSE        17  'to 602'
#                  1.            585  POP_TOP          
#              2. expr
#                 L. 254     586  LOAD_FAST             6  'revealTime'
#              3. come_from_opt
#      1. expr
#         attribute (2)
#              0. expr
#                            589  LOAD_DEREF            0  'self'
#              1.            592  LOAD_ATTR             3  'revealSpeed'
#      2. inplace_op
#                    595  INPLACE_ADD      
#      3. store
#                    596  STORE_FAST            6  'revealTime'