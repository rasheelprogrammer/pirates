...
# Embedded file name: pirates.invasion.DistributedInvasionObject
...
class MinimapInvasionObject(DirectObject):
    ...
    def __init__(self, parent, avId, xPos, yPos, isBoss):
        ...
        if isBoss:
            ...
            self.minimapObj = isBoss and GridMinimapObject(name, self.worldNode, MinimapInvasionObject.BOSS_ICON)
